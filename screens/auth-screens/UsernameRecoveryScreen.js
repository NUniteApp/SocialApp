...
function UsernameRecoveryScreen(props) {
  return (
    <View style={styles.container}>
      ...
      <Text style={[styles.text, { marginTop: 20, marginBottom: 20 }]}>Username Recovery</Text>
      ...
      <View style={{width: (windowWidth * .90)}}>
        ...
        <Text style={[styles.text, {} ]}>* We will send you a link to change your username to your university email. </Text>
